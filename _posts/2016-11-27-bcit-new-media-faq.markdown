...
###コードを書くのは向いてないと感じるがデザイナーの就職は簡単か
...
BCITで評価されてるのはコンピュータサイエンスやエンジニアリングといったコースなので、New Media自体が評価されることは特にないです。カリキュラムはとりわけ優れてるわけでもないと思います。Web業界にNew Media出身の人は多いですがそれは単に卒業人数が多いのでそう見えるのでは。